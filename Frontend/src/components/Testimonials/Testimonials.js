  ...
  return (
    <>
      <div className="py-10 mt-16">
        ...
        <p class="mx-auto max-w-screen-md text-center px-6 text-gray-500 md:text-lg">
        ...
        <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:px-20 px-10 py-20 gap-6">
          <div>
            <div className="group w-full bg-white relative flex flex-col items-center hover:bg-indigo-500 cursor-pointer shadow-md md:p-12 p-6">
