...
function Product() {
  return (
    <div>
      <div class=" mx-auto max-w-screen-lg px-4 md:px-8 py-12  flex items-end justify-between gap-4">
      ...
      >
        <div class="w-96 sm:w-72 bg-white shadow-md  duration-500 hover:scale-105 hover:shadow-xl">
          <a href="#">
            <img
              src="https://images.unsplash.com/photo-1646753522408-077ef9839300?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8NjZ8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
              alt="Product"
              class="h-80 w-96 sm:w-72 object-cover "
            />
            <div class="px-4 py-3 w-96 sm:w-72">
